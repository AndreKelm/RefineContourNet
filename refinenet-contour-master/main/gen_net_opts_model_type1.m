...
train_opts.epoch_task_num_max=1000;
...
function featnet_config=gen_featnet_config_resnet_custom(train_opts, init_resnet_layer, img_scale, output_path_num, start_stage_idx)
    ...
    featnet_config.pre_trained_model_file=sprintf('/media/apeke/fb31f06b-a384-4fd7-b65c-6701d19b70cf/refinenet-contour-master/model_trained/imagenet-resnet-%d-dag.mat', init_resnet_layer);
...
function refine_config=gen_refine_config_basic()
    ...
    refine_config.chained_pool_num=1;
    ...
    refine_config.refine_block_conv_num_mainflow=1;
    refine_config.adapt_conv_num=1;
...
refine_config.path_group_ids=[1 2 3 4 5];
