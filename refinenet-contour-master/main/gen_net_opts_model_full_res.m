function train_opts=gen_net_opts_model_full_res(run_config, class_info)
...
% random scale
data_aug_config.aug_scales=[0.7:0.1:1.1];
...
input_featnet_configs{1}=gen_featnet_config_resnet_custom(train_opts, resnet_layer_num, 1.0, 4, 1);
